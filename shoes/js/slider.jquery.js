(function($, document, window, undefined) {
    ...
    $.fn.MWslider.setHeight = function(that) {
        ...
        var width = that.width(),
			...
			setheight = $(".showcase-slider>img.center").height();
			that.css("height", setheight);
    ...
    $.fn.MWslider.addNav = function(that, f1, settings) {
        var leftArrow = $("<div class='navContainer'><div class='" + settings.nav.leftClass + "'>Prev</div>").prependTo(that),
            rightArrow = $("<div class='navContainer'><div class='" + settings.nav.rightClass + "'>Next</div>").appendTo(that);
